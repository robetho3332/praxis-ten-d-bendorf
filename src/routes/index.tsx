    ...
    <div>
      ...
      <section className="relative overflow-hidden min-h-[80vh]">
        <div className="absolute inset-0 -top-40">
          ...
          <span className="absolute bottom-6 right-6 text-foreground/60 italic z-10 text-right" style={{ fontFamily: "'Dancing Script', cursive" }}>
            <span className="text-lg md:text-xl">Sonnenberg am</span><br />
      ...
      <section className="section-padding">
        <div className="mx-auto max-w-3xl">
          <h2 className="font-heading text-lg font-semibold text-foreground md:text-xl mb-2">
            Manuelle Therapien
          </h2>
          ...
          <h2 className="font-heading text-lg font-semibold text-foreground md:text-xl mb-2 mt-12">
