    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://naturheilkundepraxis-rbt.lovable.app/logo.png",
          logo: "https://naturheilkundepraxis-rbt.lovable.app/logo.png",
          telephone: "+41794531716",
          email: "r.bertolettithoma@icloud.com",
          priceRange: "$$",
          currenciesAccepted: "CHF",
          paymentAccepted: "Cash, Invoice, TWINT",
          address: {
            "@type": "PostalAddress",
          ...
          hasOfferCatalog: {
            ...
            itemListElement: [
              ...
              { name: "Entgiftung" },
              { name: "Darmsanierung" },
              { name: "Hormonberatung", url: "https://naturheilkundepraxis-rbt.lovable.app/hormonberatung" },
              { name: "Vitalstoffberatung" },
              { name: "Ohrreflextherapie" },
              { name: "Schmerztherapie" },
              { name: "Baunscheidtieren" },
              { name: "Blutegeltherapie" },
              { name: "Laboranalysen" },
            ].map((s) => ({
              "@type": "Offer",
              itemOffered: {
    ...
    <div>
      ...
      <section className="relative overflow-hidden min-h-[80vh]">
        <div className="absolute inset-0 -top-40">
          ...
          <span className="absolute bottom-3 right-6 text-white/90 italic z-10 flex items-baseline gap-1.5 drop-shadow-[0_1px_2px_rgba(0,0,0,0.6)]" style={{ fontFamily: "'Dancing Script', cursive" }}>
            ...
            {services.map((s, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="relative font-heading text-2xl font-semibold text-background drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">{s.title}</h3>
                </div>
                <div
